...
INSERT INTO Users (UserId, Email, Password) VALUES (1, 'eloirebollo97@gmail.com', $(test_password)), (4, 'eloirebollo@gmail.com', 'Thomas Hardy');
...
CREATE TABLE IF NOT EXISTS Entreno (EntrenoId INTEGER PRIMARY KEY AUTOINCREMENT, UserId INTEGER,Data INT, CargaTotal INTEGER);
